...
const placeholderProducts = [{
  ...
  price: 79,
  imageAlt: "Fresh oranges from Vinayak Supermarket"
}, {
  id: "2",
  name: "Basmati Rice (5kg)",
  price: 549,
  imageAlt: "Premium basmati rice bag"
}, {
  id: "3",
  ...
  price: 489,
  imageAlt: "Whole wheat atta pack"
}, {
  id: "5",
  name: "Cold Pressed Oil (1L)",
  price: 299,
  imageAlt: "Cold pressed cooking oil"
}, {
  id: "6",
  name: "Green Tea (100 bags)",
  price: 199,
  imageAlt: "Green tea box"
}, {
  id: "7",
  name: "Milk (1L)",
  price: 64,
  ...
  name: "Brown Bread",
  price: 45,
  imageAlt: "Fresh brown bread loaf"
}];
const Index = () => {
  return <>
      <Helmet>
      ...
      <section className="bg-hero-gradient">
        <div className="container mx-auto px-4 py-12 md:py-20 grid md:grid-cols-2 gap-8 items-center">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">Vinayak Supermarket</h1>
          ...
          <div className="relative">
            <img src={heroImage} alt="Fresh produce and groceries at Vinayak Supermarket" loading="lazy" className="w-full h-auto rounded-lg shadow-elegant" />
          </div>
        </div>
      </section>
      ...
      <section id="catalog" className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {placeholderProducts.map(p => <ProductCard key={p.id} name={p.name} price={p.price} imageAlt={p.imageAlt} />)}
        </div>
      </section>
    </>;
};
